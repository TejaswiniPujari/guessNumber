...
document.querySelector(".check").addEventListener("click", function () {
  ...
  if (!guess) {
    ...
    document.querySelector("body").style.backgroundImage = "url('https://clipart.info/images/ccovers/1547492563congratulations-with-a-fireworks-dark-blue-background.png')";
